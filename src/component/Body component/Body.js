        ...
        <body>
            <div className="study-div">
                <div className="study">
                    ...
                    <h6>Learn new tech skills using world-class curriculum and top <br /> industry experts.</h6>

                    <button> <a href="./Nav">Start Now</a> </button>
            ...
            <h3> Our alumni work at world-class <br />companies around the world including</h3>
            ...
            <div className="make-afrika">
                ...
                <div className="afr-worda">
                    <h1>Making Africa a Tech Continent…</h1>
                    <h5>Since her inception in 2008, SQI have been at the forefront of providing reliable ICT Training and Solutions over these years</h5>
                    <h5>SQI has trained and certified over 7000 students who are doing well in various places across the globe.</h5>
                    <h5>Now it’s your turn to enjoy sound teaching and guidance from leading professionals in the industry.</h5>
            ...
            <div className="courses-div">
                <div className="course">
                    ...
                    <h5>Take a look at some of our popular courses</h5>
            ...
            <div className="ready-div">
                <h5>IT’S TIME FOR YOU TO TAKE YOUR TECH CAREER TO THE NEXT LEVEL</h5>
                <h1>Ready to Get Started?</h1>
                <h6>We provide and lead others in quality education, service, industry,  and <br />character as well as discipline.</h6>
